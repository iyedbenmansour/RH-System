...
class ReclamationController extends AbstractController
{
    ...
    ): Response
    {
        ...
        // Find not treated reclamations with optional search
    ...
    #[Route('/my-reclamations', name: 'app_reclamation_my_list', methods: ['GET'])]
    ...
    {
        // Dans un vrai système d'authentification, nous utiliserions le user ID de l'utilisateur connecté
        // Pour l'exemple, nous allons utiliser un paramètre de requête pour simuler différents utilisateurs
        $userId = $request->query->getInt('userId', 1); // Valeur par défaut: 1
