...
public function login(Request $request): Response
{
    if ($request->isMethod('POST')) {
        ...
        if ($admin) {
            ...
            $script = "
                <script>
                    localStorage.setItem('admin_id', '{$admin->getId()}');
                    localStorage.setItem('admin_name', '".addslashes($admin->getName())."');
                    localStorage.setItem('admin_email', '".addslashes($admin->getEmail())."');
                </script>
            ";
